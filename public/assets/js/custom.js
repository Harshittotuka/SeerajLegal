...
$(function () {
    ...
    $(document).ready(function () {
        ...
        // Get the correct logo URLs from the Blade template
        var defaultLogo = $("#logo").data("default-logo");
        var scrollLogo = $("#logo").data("scroll-logo");
        ...
        wind.on("scroll", function () {
            ...
            if (bodyScroll > 100) {
                navbar.addClass("nav-scroll");
                logo.attr('src', scrollLogo); // Use correct asset URL
            } else {
                navbar.removeClass("nav-scroll");
                logo.attr('src', defaultLogo); // Use correct asset URL
            }
        });
    });
