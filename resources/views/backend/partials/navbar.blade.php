  ...
  <div class="sidenav-header d-flex align-items-center justify-content-between px-3 py-2">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
         ...
         <!-- Members Dropdown -->
         <li class="nav-item">
             <a class="nav-link {{ Request::is('backend/members') || Request::is('backend/members/manage') ? 'active bg-light text-dark' : 'text-dark' }}" data-bs-toggle="collapse" href="#members-collapse" role="button" aria-expanded="false" aria-controls="members-collapse">
                 <i class="fas fa-users fa-sm opacity-5 me-2"></i>
                 <span class="nav-link-text ms-1">Members</span>
             </a>
             <div class="collapse {{ Request::is('backend/members') || Request::is('backend/members/manage') ? 'show' : '' }}" id="members-collapse" data-bs-parent="#sidenav-collapse-main">
                 <ul class="nav flex-column ps-4">
                     <li class="nav-item">
