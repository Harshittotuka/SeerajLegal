    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                updateBreadcrumbs(["Dashboard", "Practices", "Create"], ["/backend/dashboard", "/backend/practice/list", "#"]);
            });
        </script>
    ...
    <script>
            ...
            fetch(`/api/practices/search?name=${encodeURIComponent(practiceName)}`)
                ...
                .then(data => {
                    ...
                    viewButton.addEventListener("click", function() {
                        window.open(
                            `${window.location.origin}/practice/${encodeURIComponent(practiceName)}`,
                            "_blank");
                    });
                })
                .catch(error => {
        ...
        function populateForm(practiceData) {
            ...
            if (practiceData.length > 0) {
                ...
                const autoFilledPractice = practiceData[0].practice_name;

                if (autoFilledPractice && autoFilledPractice.trim() !== "") {
                    nameInput.value = autoFilledPractice;
        ...
        document.addEventListener("DOMContentLoaded", function() {
            document.getElementById("saveButton").addEventListener("click", function() {
                ...
                const practiceNameFromUrl = urlParams.get("practicename");
                 const isCreating = !practiceNameFromUrl;   
