                    ...
                    <div class="contact-form">
                        <form method="POST" id="contact-form" action="{{ route('contact.send') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <textarea name="message" cols="40" rows="4" placeholder="Message" required></textarea>
                                </div>
                                <div class="col-md-12">
                    ...
                    if (data.personal_details) {
                        ...
                        if (contact.whatsapp) {
                            socialIcons.innerHTML +=
                                `<a href="${contact.whatsapp}" target="_blank" title="WhatsApp"><i class="fab fa-whatsapp"></i></a>`;
                        }
                        if (contact.twitter_link) {
                            socialIcons.innerHTML +=
                                `<a href="${contact.twitter_link}" target="_blank" title="Twitter"><i class="fab fa-twitter"></i></a>`;
                        }
                        if (contact.facebook_link) {
                            socialIcons.innerHTML +=
                                `<a href="${contact.facebook_link}" target="_blank" title="Facebook"><i class="fab fa-facebook-f"></i></a>`;
                        }
                        if (contact.insta_link) {
                            socialIcons.innerHTML +=
                                `<a href="${contact.insta_link}" target="_blank" title="Instagram"><i class="fab fa-instagram"></i></a>`;
                        }
                        if (contact.youtube_link) {
                            socialIcons.innerHTML +=
                                `<a href="${contact.youtube_link}" target="_blank" title="YouTube"><i class="fab fa-youtube"></i></a>`;
                        }
                        if (contact.linkedin) {
                            socialIcons.innerHTML +=
                                `<a href="${contact.linkedin}" target="_blank" title="LinkedIn"><i class="fab fa-linkedin-in"></i></a>`;
                        }
                        ...
                        if (socialIcons.innerHTML.trim() !== "") {
                            ...
                            socialIcons.classList.add(
                                "contact-social-icons"); // optional class for consistent styling
                        }
                    }
                })
