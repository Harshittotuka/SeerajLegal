...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-CM8F3LX7DS"></script>
    <script>
...
<body>
    ...
    <aside class="kenburns-section" id="kenburnsSliderContainer" data-overlay-dark="5">
        ...
        <style>
            ...
            .small-title {
                font-size: 1.8rem;
                /* Or 1.8rem, depending on what you prefer */
                display: block;
                margin-top: 10px;
                ...
                <div class="v-middle">
                    <div class="row justify-content-center align-items-center hero-header">
                        <div class="col-lg-8 col-md-12 text-center">
                            ...
                            <!-- Dynamic Title -->
                            <h1 id="slider-title" class="hero-title large-title"></h1>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 col-md-12 mb-30">
                    ...
                    <div class="section-title" id="adr-title">ADR</div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            fetch('/home.json')
                ...
                .then(data => {
                    ...
                    document.getElementById("adr-title").innerHTML = serviceData.title;
        ...
        document.addEventListener("DOMContentLoaded", function() {
            fetch('home.json')
                ...
                .then(data => {
                    ...
                    // ✅ Populate data
                    titleElement.innerHTML = sectionData.title || "Default Title";
